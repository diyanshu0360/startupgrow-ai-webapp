...
export async function POST(req: NextRequest, res: NextResponse) {
    ...
    try {
        ...
        const productHuntPrompt = [
            "Consider yourself as experienced Product Hunt content writer. I want you to write me tagline, description & comment for a product launch. I'll give you landing page content, you need to write above content. Tagline should be short, straight to the point, and possibly trigger an emotional reaction. Description should be about explain product. Comment should be journey about why your created this product, explain advantages and ask for feedback Consider yourself as 'I'. Should end with a CTA. Strictly no use of emoji.",
            "Consider yourself as experienced Product Hunt content writer. I want you to write another set of content for tagline, description & comment for a product launch. Consider all content different from previous. I'll give you landing page content, you need to write above content. Tagline should be short, straight to the point, and possibly trigger an emotional reaction. Description should be about explain product. Comment should be journey about why your created this product, explain advantages and ask for feedback Consider yourself as 'I'. Should end with a CTA. Strictly no use of emoji."
        ]
